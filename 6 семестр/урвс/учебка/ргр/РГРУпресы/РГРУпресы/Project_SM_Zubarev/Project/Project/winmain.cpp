...
void thread()
{
	...
	if (hinstLib != NULL)
	{
		...
		switch(mounth){
			case 1:
				strcpy(this_mounth, "январь\0");
			break;
			case 2:
				strcpy(this_mounth, "февраль\0");
			break;
			case 3:
				strcpy(this_mounth, "март\0");
			break;
			case 4:
				strcpy(this_mounth, "апрель\0");
			break;
			case 5:
				strcpy(this_mounth, "май\0");
			break;
			case 6:
				strcpy(this_mounth, "июнь\0");
			break;
			case 7:
				strcpy(this_mounth, "июль\0");
			break;
			case 8:
				strcpy(this_mounth, "август\0");
			break;
			case 9:
				strcpy(this_mounth, "сентябрь\0");
			break;
			case 10:
				strcpy(this_mounth, "октябрь\0");
			break;
			case 11:
				strcpy(this_mounth, "ноябрь\0");
			break;
			case 12:
				strcpy(this_mounth, "декабрь\0");
			break;
			default:
				strcpy(this_mounth, "трава, на траве дрова...\0");
			break;
		}
...
\nНа дворе %s", this_mounth);
		
		char cpuString[1024];
		sprintf_s(cpuString, "Дополнительное задание:\n\
\"Определить ассоциативность КЭШа данных второго уровня\"\n\
Кэш: %d уровня (L%d cache)\n\
Ассоциативность: %s",\
		cache_level, cache_level,\
		cache_associative != 0 ? "есть" : "нет");
